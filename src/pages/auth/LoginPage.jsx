  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-950 px-4 py-8">
      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/95 p-6 shadow-2xl backdrop-blur dark:bg-slate-900/90">
        <div className="mb-6">
          <p className="font-display text-2xl font-bold text-slate-900 dark:text-slate-100">Welcome back</p>
          <p className="text-sm text-slate-500 dark:text-slate-400">Sign in to manage your ERP operations.</p>
        </div>
        ...
        <p className="mt-5 text-sm text-slate-500 dark:text-slate-400">
          New to ERP Pulse?{' '}
          <Link to="/register" className="font-medium text-teal-600 hover:text-teal-500 dark:text-teal-300">
            Create account
          </Link>
        </p>
      </div>
